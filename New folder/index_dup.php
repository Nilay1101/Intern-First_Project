...
<img src="images/icons/Archery.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/Cricket.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/cycling-icon.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
 <img src="images/icons/BasketBall.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/weightLiftingIcon.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/Fast Runner.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/Hockey.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/swimming.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
<div class="col-lg-1 text-center">
<img src="images/icons/shooting.png" style="margin-top: 150px; height: 50px; margin-left: 50px; ">
</div>
...
<div class="col-lg-1text-center"></div>
       ...
       <div class="icons" style="width:100%; padding: 5px; border: 2px solid seagreen ; margin-bottom: 6px; background:#458B00 url('..img/pattern.png')"></div>         
        <div>           
            <div class="jumbotron" style="margin-top:-6px;background-image: url(images/search2.jpg)";>
                <h2 class="text-center">
                    Hello!<br>
                    Here you can search different Academy, Coach, Tournament<br></h2>
                ...
                <form action="result.php" method="POST">
                    <div class="form-group form-inline text-center has-feedback" style="margin-top: 15px;">
                        <div class="input-group" style="margin-left:-70px">
                            ...
                            <span style="background:white" class="input-group-addon"><span style="background:white"class=" glyphicon glyphicon-chevron-down"></span></span>
                        </div>
                        
                        <div class="input-group"style="margin-left:-5px">
						<span style="background:white" class="input-group-addon"><span style="background:white" class=" glyphicon glyphicon-search"></span></span>
                                <input style="height:45px; width:500px" id="area" class="form-control search_input" name="query" placeholder="Search any Academy/Tournament/Venue/Coach..." >
                        </div>	
						<div class="adjust" style="margin-top:-60px;margin-right:-832px;">
...
<div class="hex-row even">
    ...
    <div class="hex-row">
        ...
        <div class="hex0" data-toggle="tab" href="#content_for_id4"><div class="top"></div><div class="middle"><div class="themeText"></div><img class="themeIcon" style="height:100px; width:120px;"src="images/logo.png" alt="SPORTS"></div><div class="bottom"></div></div>
