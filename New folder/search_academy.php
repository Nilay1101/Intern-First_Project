...
?>
       ...
       if(isset($_POST['coaches_sub']))
       {
            ...
            $mysql_query_academy = 'SELECT acc_id, name_academy, address, timings, fees, coaches FROM academies where ('.$typeString.') AND name_academy like \'%'.$search_query.'%\' ORDER BY coaches';
