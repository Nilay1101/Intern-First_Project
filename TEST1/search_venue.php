...
<html>
    ...
    <body>
        ...
        <div class="searchbar container-fluid">
                    <form action="search_venue.php" method="POST">
       ...
       echo '<h2>'.$typeString.'</h2>';
        ...
        if(!$multiple && !$error){
            ...
            switch ($search_query_type) {
                ...
                case 'Academies':
                    echo '<script>window.location="search_academy.php";</script>';
        ...
        if(!strcmp($search_query,$null)&&!isset($_POST['fees_sub'])&&!isset($_POST['a-z_sub']))
        {
            ...
            <div class="col-md-6">
                <div class="form-group form-inline sorting">
                    <form action="search_academy.php" method="post">
                ...
                <div class="container resultbox">
                    ...
                    <?php   if($multiple && !$error){
                                if(mysql_num_rows($result_academy)==0 && mysql_num_rows($result_tournament)==0 && mysql_num_rows($result_venue)==0){
