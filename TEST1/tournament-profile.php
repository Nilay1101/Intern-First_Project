...
<html>
    <head>
        ...
        <link href="css/tournament-profile.css" rel="stylesheet">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="40">
         ...
         <?php   
                ...
                $query =  'SELECT * FROM th_tournamentregister_mumbai WHERE id=\''.$_GET['id'].'\'';
                $result = mysql_query($query,$conn);
                while($row = mysql_fetch_array($result,MYSQL_ASSOC)){
        ?>
        <div class="start"></div>
        <div class="container-fluid text-center name">
            <h2 style="color:white"><?php echo $row['tourn_name']; ?></h2>
        </div>
        <div class="prize">Prize <?php echo $row['prize_money'];  ?></div>
        <div class="banner">
                    ...
                    <div class="col-md-3">
                        <div style="margin-left:10px;margin-right:-25px "class="text-center container-fluid box">
                                ...
                                <div class="text-left">
                                    ...
                                    <div>
                                        <h2>Fees</h2>
                                        <h4><?php echo $row['reg_fees'];  ?></h4>
                                    </div>
                                    <div>
                                        <h2>Contact Details</h2>
                                        <h4><?php echo $row['contacts'];  ?></h4>
                                    </div>
									<br>
...
<a href="#"><h6>Read more...</h6></a>								
                    ...
                    <div style=" margin-top:5px;margin-left:-25px; margin-right:0px" class="container-fluid text-center box">                           
							...
							<ul>
							<li><?php echo $row['tourn_rules'];  ?></li>
							<li>Rule 2</li>
							<li>Rule 3</li>
							<li>Rule 4</li>
							<li>Rule 5</li>
