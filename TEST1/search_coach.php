...
<html>
    ...
    <body>
       ...
       echo '<h2>'.$typeString.'</h2>';
        ...
        if(!$multiple && !$error){
            ...
            switch ($search_query_type) {
                ...
                case 'Tournaments':echo '<script>window.location="search_tournament.php";</script>';
                    ...
                    break;
                case 'Coaches':
                    $mysql_query =  'SELECT id, name, city, select_sport, feespm FROM th_coachregister_mumbai where ('.$typeString.') AND name like \'%'.$search_query_term.'%\'';
            ...
            if(!isset($_POST['fees_sub'])&&!isset($_POST['a-z_sub'])&&!isset($_POST['coaches_sub'])){
            
            $mysql_query_coach =   'SELECT id, name, city, select_sport, feespm FROM th_coachregister_mumbai where ('.$typeString.') AND name like \'%'.$search_query.'%\'';
        ...
        $null = '';
        if(!strcmp($search_query,$null)&&!isset($_POST['fees_sub'])&&!isset($_POST['a-z_sub']))
        {
...
?>
       ...
       if(isset($_POST['fees_sub']))
       {
            ...
            $mysql_query_coach =   'SELECT id, name, city, select_sport, feespm FROM th_coachregister_mumbai where ('.$typeString.') AND name like \'%'.$search_query.'%\' ORDER BY feespm';
            ;
       ...
       if(isset($_POST['a-z_sub']))
       {
             ...
             'SELECT id, name, city, select_sport, feespm FROM th_coachregister_mumbai where ('.$typeString.') AND name like \'%'.$search_query.'%\' ORDER BY name';
                ...
                <div class="container resultbox">
                    ...
                    <?php   if($multiple && !$error){
                                if(mysql_num_rows($result_academy)==0 && mysql_num_rows($result_tournament)==0 && mysql_num_rows($result_coach)==0){
                                    ...
                                    retrieveAcademiesResult($result_academy);
                                    retrieveTournamentsResult($result_tournament);
                                    retrievCoachesResult($result_coach);
                                }
