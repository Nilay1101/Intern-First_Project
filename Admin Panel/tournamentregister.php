...
<link rel="stylesheet" href="css/bootstrap-multiselect.css" type="text/css"/>
    ...
    <div class="navbar-header col-md-3">
		...
		<div class="container" style="position:relative;top:110px">
			...
			<form action="tournamentregister.php" method=POST enctype="multipart/form-data" data-toggle="validator" role="form">
				<div class="form-group has-feedback" >
					<div class="row">
					<div class="col-md-4" style="background-color:#4DD0E1;height:1150px;">
						...
						<div class="row" style="position:relative;top:40px;" >
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									<input type="text" class="form-control" name="tourn_name" placeholder="Tournament Name" pattern="^([a-zA-Z0-9]+)$" data-error="Do not leave blank" required>
									<span class="help-block with-errors"></span>
								</div>
								...
								<div class="form-group">
									<input type="textarea" class="form-control" name="venue" pattern="^([a-zA-Z0-9]+)$" placeholder="Venue" data-error="Do not leave Blank" required>
									<span class="help-block with-errors"></span>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" pattern="^([a-zA-Z]+)$" name="contact_name" placeholder="Contact Person Name" data-error="Do not leave blank or insert numbers or characters" required>
											<span class="help-block with-errors"></span>
									...
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" name="contacts" pattern="^([a-zA-Z0-9]+)$" placeholder="Contacts" data-error="Do not leave blank" required>
											<span class="help-block with-errors"></span>
										</div>
									</div>
								</div>
					...
					<div class="col-md-3" style="background-color:#4DD0E1;height:1150px">
						<div class="row" style="position:relative;top:40px;" >
							<div class="col-md-12">
							<div style="background-color:#81C784;padding:10px 5px 10px 20px;border-radius:5px">
								...
								<br>
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="commentary" >
									<label>Commentary</label>
								</div>
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="umpires" >
									<label>Umpires</label>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="refreshments" >
									<label>Refreshments</label>
								</div>
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="video recording" >
									<label>Video Recording</label>
								</div>
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="basic equipment" >
									<label>Basic Equipment</label>
								</div>
								<div class="form-group">
					...
					<div class="col-md-5" style="background-color:#4DD0E1;height:1150px;">
					
						<div class="row" style="position:relative;top:40px;" >
							<div class="col-md-10">
								<div class="form-group">
											<input type="number" class="form-control" name="reg_fees" pattern="^([0-9]+)$" placeholder="Registration Fees" data-error="PLease enter only numbers" required>
											<span class="help-block with-errors"></span>
								</div>
										...
										<div class="form-group">
											<input type="text" class="form-control" name="tourn_start_date" pattern="^([a-zA-Z0-9]+)$"  placeholder="Tournament Start Date" data-error="Do not leave blank" required>
											<span class="help-block with-errors"></span>
								</div>
									
									
										<div class="form-group">
											<input type="text" class="form-control" name="tourn_end_date" pattern="^([a-zA-Z0-9]+)$"  placeholder="Tournament End Date" data-error="Do not leave blank" required>
											<span class="help-block with-errors"></span>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<input type="number" class="form-control" name="prize_money" pattern="^([a-zA-Z0-9]+)$"  placeholder="Prize Money" data-error="Please enter only numbers and Do not leave blank" required>
											<span class="help-block with-errors"></span>
									</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" name="live_update" pattern="^([a-zA-Z0-9]+)$"  placeholder="Live Update" data-error="Please enter only numbers and Do not leave blank" required>
											<span class="help-block with-errors"></span>
									</div>
									</div>
								</div>
								...
								<div class="form-group">
									<textarea type="textarea" class="form-control" name="tourn_rules" pattern="^([a-zA-Z0-9]+)$" placeholder="Tournament Rules" rows="2" data-error="Do not leave Blank" required></textarea>
									<span class="help-block with-errors"></span>
								</div>
								<div class="form-group">
											<input type="text" class="form-control" name="results" pattern="^([a-zA-Z0-9]+)$"  placeholder="Results" data-error="Please enter only numbers and Do not leave blank" required>
											<span class="help-block with-errors"></span>
									</div>
								<div class="form-group">
									<textarea type="textarea" class="form-control" name="schedule" pattern="^([a-zA-Z0-9]+)$" placeholder="Schedule" rows="2" data-error="Do not leave Blank" required></textarea>
									<span class="help-block with-errors"></span>
								</div>
								<div class="form-group">
									<textarea type="textarea" class="form-control" name="about_us" pattern="^([a-zA-Z0-9]+)$" placeholder="About Us" rows="3" data-error="Do not leave Blank" required></textarea>
									<span class="help-block with-errors"></span>
								</div>
...
<?php
	...
	if($_POST['submit1'])
	{
		...
		$tourn_start_date=$_POST['tourn_start_date'];
		$tourn_end_date=$_POST['tourn_end_date'];
		$prize_money=$_POST['prize_money'];
		$live_update=$_POST['live_update'];
		$tourn_rules=$_POST['tourn_rules'];
	    ...
	    $sports=implode(',', $_POST['selected_sports']);
			    ...
			    if($city=="Mumbai"){
			mysql_query("INSERT INTO th_tournamentregister_mumbai VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Hyderabad"){
			mysql_query("INSERT INTO th_tournamentregister_hyderabad VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Pune"){
			mysql_query("INSERT INTO th_tournamentregister_pune VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Ahmedabad"){
			mysql_query("INSERT INTO th_tournamentregister_ahmedabad VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Bangalore"){
			mysql_query("INSERT INTO th_tournamentregister_bangalore VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Delhi"){
			mysql_query("INSERT INTO th_tournamentregister_delhi VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Chennai"){
			mysql_query("INSERT INTO th_tournamentregister_chennai VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
			    if($city=="Kolkata"){
			mysql_query("INSERT INTO th_tournamentregister_kolkata VALUES('','$sports','$tourn_name','$city','$area','$venue','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$contact_name','$contacts','$facilities1','$gender','$reg_fees','$tourn_start_date','$tourn_end_date','$prize_money','$live_update','$tourn_rules','$results','$schedule','$about_us')");
			    }
