		...
		<div class="container" style="position:relative;top:110px">
			...
			<form action="#" method=POST enctype="multipart/form-data" data-toggle="validator" role="form" >
				<div class="form-group has-feedback" >
					<div class="row">
					<div class="col-md-4" style="background-color:#4DD0E1;height:900px;">
						
						<div class="row" style="position:relative;top:40px;" >
						
							<div class="col-md-12">
								<div class="form-group">
								<select name="selected_sports[]" id="select_sport" multiple="multiple" placeholder="Select Sports" required>
								...
								<div class="form-group dropdown">
									<script type="text/javascript">
										var city_arr = new Array("Mumbai", "Hyderabad", "Pune", "Bangalore","Ahmedabad","Bangalore","Delhi","Chennai","Kolkata");
									...
									<select class="form-control" onchange="print_area('area',this.selectedIndex);" id="city" name ="city"></select>
								...
								<div class="form-group">
									<textarea type="textarea" class="form-control" name="address" placeholder="Full address" pattern="^([a-zA-Z0-9]+)$" data-error="Do not leave Blank" rows="2" required></textarea>
									<span class="help-block with-errors"></span>
								...
								<div class="form-group">
											<input type="text" class="form-control" name="directions" pattern="^([a-zA-Z0-9]+)$" placeholder="Directions" data-error="Do not leave Blank" required>
											<span class="help-block with-errors"></span>
								</div>
								<div class="form-group">
											<input type="text" class="form-control" name="lat_long" pattern="^([a-zA-Z0-9]+)$" placeholder="Latitude and Laongitude(Google map)" data-error="Do not leave Blank" required>
											<span class="help-block with-errors"></span>
								</div>
								<div class="form-group">
											<input type="number" class="form-control" name="tele_number"  pattern="^([0-9]+)$" placeholder="Office Telephone Number" data-error="Please insert only numbers" required>
											<span class="help-block with-errors"></span>
								</div>
								<div class="form-group">
											<input type="number" class="form-control" name="mob_number"  pattern="^([0-9]+)$" placeholder="Mobile Number" data-error="Please insert only numbers" required>
											<span class="help-block with-errors"></span>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" name="website" pattern="^(http:\/\/|https:\/\/)?(www.)?([a-zA-Z0-9]+).[a-zA-Z0-9]*.[a-z]{3}.?([a-z]+)?$" placeholder="Website" data-error="Please enter in this format www.xyz.com" required>
											<span class="help-block with-errors"></span>
										</div>
									</div>
								</div>
					...
					<div class="col-md-3" style="background-color:#4DD0E1;height:900px">
						<div class="row" style="position:relative;top:40px;" >
							<div class="col-md-12">
							<div style="background-color:#81C784;padding:10px 5px 10px 20px;border-radius:5px">
								...
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="dougout" >
									<label>Doug-out</label>
								</div>
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="score card" >
								...
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="shower" >
									<label>Shower</label>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="boundary markings" >
									<label>Boundary Markings</label>
								</div>
								<div class="form-group">
									<input type="checkbox" name="facilities_check1[]" value="flood lights" >
					...
					<div class="col-md-5" style="background-color:#4DD0E1;height:900px;">
						...
						<div class="row" style="position:relative;top:40px;" >
							<div class="col-md-10">
							    <div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" name="owner_name" placeholder="Owner Name" pattern="^([a-zA-Z]+)$" data-error="Do not leave blank or Do not enter numbers or characters" required>
											<span class="help-block with-errors"></span>
								...
								<div class="form-group">
											<input type="number" class="form-control" name="feespm"  pattern="^([0-9]+)$" placeholder="Fees per Month" data-error="Please insert only numbers" required>
											<span class="help-block with-errors"></span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
											<textarea type="text" class="form-control" name="about_us" pattern="^([a-zA-Z0-9]+)$" placeholder="About Us" rows="3" data-error="Do not leave Blank" required></textarea>
											<span class="help-block with-errors"></span>
								</div>
								
								<div class="form-group">
									<label for="exampleInputFile">Upload Images</label>
									<p class="help-block" style="color:black">Max size:2MB</p>
								...
								<div class="form-group">
									<label for="exampleInputFile">Carousal Image</label>
									<p class="help-block" style="color:black">Max size:2MB</p>
									<input type="file" id="InputFile2" name="carousal_image" data-error="Please upload valid images" required>
									<span class="help-block with-errors"></span>
...
<?php
	...
	if($_POST['submit1'])
	{
		...
		$about_us=$_POST['about_us'];
		 ...
		 $sports=implode(',', $_POST['selected_sports']);
			...
			if($sports&&$name1&&$address&&$landmark&&$pincode&&$directions&&$lat_long&&$tele_number&&$mob_number&&$email&&$website&&$owner_name&&$owner_contacts&&$timings&&$feespm&&$fees&&$about_us)
			{
			    
			    
			    if($city=="Mumbai")
			    {
			mysql_query("INSERT INTO th_venueregister_mumbai VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Hyderabad")
			    {
			mysql_query("INSERT INTO th_venueregister_hyderabad VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Pune")
			    {
			mysql_query("INSERT INTO th_venueregister_pune VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Ahmedabad")
			    {
			mysql_query("INSERT INTO th_venueregister_ahmedabad VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Delhi")
			    {
			mysql_query("INSERT INTO th_venueregister_delhi VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Bangalore")
			    {
			mysql_query("INSERT INTO th_venueregister_bangalore VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Chennai")
			    {
			mysql_query("INSERT INTO th_venueregister_chennai VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
			
			    }
			     if($city=="Kolkata")
			    {
			mysql_query("INSERT INTO th_venueregister_kolkata VALUES('','$sports','$name1','$city','$area','$address','$landmark','$pincode','$directions','$lat_long','$tele_number','$mob_number','$email','$website','$owner_name','$owner_contacts','$timings','$facilities1','$feespm','$fees','$about_us')");
   ...
   if(isset($_FILES['carousal_image'])){
      $errors= array();
      $file_name = $_FILES['carousal_image']['name'];
      $file_size =$_FILES['carousal_image']['size'];
      $file_tmp =$_FILES['carousal_image']['tmp_name'];
      $file_type=$_FILES['carousal_image']['type'];
      $file_ext=strtolower(end(explode('.',$_FILES['carousal_image']['name'])));
